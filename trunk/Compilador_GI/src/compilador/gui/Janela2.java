...
public class Janela2 extends javax.swing.JFrame {
    ...
    public Janela2() {
        ...
        //jTextAreaCodigoFonte = JEditor.getInstance();
        //jTextAreaCodigoFonte.getTextPane().setBorder(new NumberedBorder());
    }
    ...
    private void initComponents() {
        ...
        jScrollPane1.setViewportView(jTextAreaCodigoFonte.getTextPane());
    ...
    private void jMenuItemLimparActionPerformed(java.awt.event.ActionEvent evt) {
        limparFrameDeErros();
        limparTabelaDeTokens();
    }

    private void jButtonAjudaActionPerformed(java.awt.event.ActionEvent evt) {
        new Ajuda().setVisible(true);
    }

    private void jMenuItemAjudaActionPerformed(java.awt.event.ActionEvent evt) {
        new Ajuda().setVisible(true);
    }
   ...
   private void abrirArquivo()
    {
        ...
        if (opcao == JFileChooser.APPROVE_OPTION) {
            try {
                ...
                jTextAreaCodigoFonte.getTextPane().setText(aux);
    ...
    private void salvarArquivo()
    {
        ...
        if (opcao == JFileChooser.APPROVE_OPTION) {
            ...
            try {
                ...
                writer.write(jTextAreaCodigoFonte.getTextPane().getText());
                writer.close();
...
//----- MÉTODOS AUXILIARES -----------------------------------------------------
    ...
    private boolean codigoFonteVazio()
    {
        ...
        return jTextAreaCodigoFonte.getTextPane().getText().equals("");
    }

    private void limparFrameDeCodigoFonte()
    {
        //this.jTextAreaCodigoFonte.setText("");
        this.jTextAreaCodigoFonte.getTextPane().setText("");
    }
...
//    }
    ...
    private JEditor jTextAreaCodigoFonte;
